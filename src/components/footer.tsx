...
const Footer = () => {
  return (
    <Card className="py-4 px-12 !border-x-transparent !border-b-transparent !rounded-none flex flex-col items-center justify-between gap-5 sm:flex-row dark:border-white/5">
